...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/12 15:02:51 by fsalazar          #+#    #+#             */
/*   Updated: 2023/09/12 15:02:52 by fsalazar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Serializer
{
    public:
        ...
        // Constructor and destructor are public to allow creating and destroying instances of the class
        Serializer();
        ~Serializer();
    private:
        // Copy constructor and assignment operator are private to prevent copying
